...
start "AI Backend :8000" cmd /k "cd musicgen-api && python main.py"
timeout /t 5 /nobreak > nul

echo [2/3] Starting IPFS Service (Dev 3)...
start "IPFS Service :3001" cmd /k "cd ipfs && npm start"
timeout /t 5 /nobreak > nul
...
echo Address: 0x8E65aEe95f6B0249eAD4A4847E5e398551C97D52
echo Explorer: https://sepolia.etherscan.io/address/0x8E65aEe95f6B0249eAD4A4847E5e398551C97D52
echo.
